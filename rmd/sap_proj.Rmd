...
\textbf{Normalnost reziduala i homogenost varijance:  }
...
captions2 = c("Histogram reziduala modela kilaže i visine",
              "Prikaz g-g plota reziduala modela kilaže i visine s linijom normalne distribucije", 
...
captions3 = c("Histogram reziduala modela kilaže i opsega struka",
              "Prikaz g-g plota reziduala modela kilaže i opsega struka s linijom normalne distribucije", 
...
captions4 = c("Histogram reziduala modela kilaže i opsega vrata",
              "Prikaz g-g plota reziduala modela kilaže i opsega vrata s linijom normalne distribucije", 
...
captions5 = c("Histogram reziduala modela kilaže i duljine prednjeg struka u sjedećem položaju",
              "Prikaz g-g plota reziduala modela kilaže i duljine prednjeg struka u sjedećem položaju s linijom normalne distribucije", 
...
captions6 = c("Histogram reziduala modela kilaže i opsega bedra",
              "Prikaz g-g plota reziduala modela kilaže i opsega bedra s linijom normalne distribucije", 
...
\textbf{Ocjena kvalitete linearnog modela i statističko zaključivanje o procijenjenom modelu:  }
...
\textbf{Korelacijski koeficijenti u linearnom modelu:  }
...
```{r echo = FALSE, results=FALSE}
captions7 = c("Histogram reziduala višestruke regresije",
              "Prikaz g-g plota reziduala višestruke regresije", 
              "Reziduali višestruke regresije")
```
\newpage
\textbf{Provjera normalnosti reziduala: }  
...
```
p-vrijednost od 0.6708 nam govori da nećemo odbaciti hipotezu $H_0$ da su varijance naša dva uzorka jednaka.
...
### Sada želimo provjeriti imaju li vojnici dešnjaci veći opseg desnog bicepsa od ambidekstrenih vojnika.
